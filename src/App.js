...
let quiz1 = `${obj.map(s => s.quizOne + ": ")}
                ${getAvg(scoresOne)}, max: 
                ${getMax(scoresOne)} (
                ${getNameMax(scoresOne, nameOne)}), min: 
                ${getMin(scoresOne)} (
                ${getNameMin(scoresOne, nameOne)})`;

let quiz2 = `${obj.map(s => s.quizTwo + ": ")}
                ${getAvg(scoresTwo)}, max: 
                ${getMax(scoresTwo)} (
                ${getNameMax(scoresTwo, nameTwo)}), min: 
                ${getMin(scoresTwo)} (
